...
String buildConfigPage() {
  ...
  html += "<input type='text' name='lm_host' class='form-input' value='" + cfg.lm_host + "' placeholder='http://10.0.0.10:1234'>";
  html += "</div>";
  html += "<div class='form-group'>";
  html += "<label class='form-label'>Modèle</label>";
  html += "<div class='input-group'>";
  html += "<select id='model-select' name='lm_model' class='form-select'>";
  html += "<option value='" + cfg.lm_model + "'>" + cfg.lm_model + "</option>";
  html += "</select>";
  html += "<button type='button' id='refresh-models-btn' class='btn btn-secondary btn-small' onclick='refreshModels()'>🔄 Rafraîchir</button>";
  html += "</div>";
  html += "</div>";
  html += "</div>";
  ...
  html += "<input type='text' name='lm_host' class='form-input' value='" + cfg.lm_host + "' placeholder='http://10.0.0.10:11434'>";
  html += "</div>";
  html += "<div class='form-group'>";
  html += "<label class='form-label'>Modèle</label>";
  html += "<div class='input-group'>";
  ...
  html += "<input type='password' name='openai_key' class='form-input' value='" + cfg.openai_key + "' placeholder='sk-...'>";
  html += "</div>";
  html += "<div class='form-group'>";
  html += "<label class='form-label'>Modèle</label>";
  html += "<select name='lm_model' class='form-select'>";
